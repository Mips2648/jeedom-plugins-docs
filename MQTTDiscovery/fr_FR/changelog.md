...
- Ajout d'un bouton pour ouvrir la configuration du module si l'url est fournie dans les informations de découvertes (par exemple vers la config du module sur zigbee2mqtt)
