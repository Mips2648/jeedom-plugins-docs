...
> **Important**
>
> Ce plugin n’est pas compatible avec les systèmes 32 bits, notamment les installations Raspberry Pi 3B utilisant un OS 32 bits.
...
- tous les logs disponibles du plugin, en niveau _INFO_, collés dans un `Texte préformaté` (bouton `</>` sur community), pas de fichiers!
