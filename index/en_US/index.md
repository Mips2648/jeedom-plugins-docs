...
[<img width="77" src="{{site.market}}/filestore/market/plugin/images/gotify_icon.png">]({{site.baseurl}}/gardena/{{page.lang}})
...
[<img width="77" src="{{site.market}}/filestore/market/plugin/images/logmanager_icon.png">]({{site.baseurl}}/influxdb/{{page.lang}})
...
[<img width="77" src="{{site.market}}/filestore/market/plugin/images/miele_icon.png"/>]({{site.baseurl}}/logmanager/{{page.lang}})

Plugin allowing to integrate all appliances compatible with Miel@Home.

- [It is possible to get appliances information, to monitor them and execute some actions (depending the appliance). ]({{site.baseurl}}/logmanager/{{page.lang}})
- [Documentation]({{site.baseurl}}/logmanager/{{page.lang}}/changelog)
- Changelog
...
[<img width="77" src="{{site.market}}/filestore/market/plugin/images/notificationqueue_icon.png">]({{site.baseurl}}/myaudi/{{page.lang}})
...
[<img width="77" src="{{site.market}}/filestore/market/plugin/images/onduleursolaredge_icon.png">]({{site.baseurl}}/notificationqueue/{{page.lang}})
...
[<img width="77" src="{{site.market}}/filestore/market/plugin/images/portainer_icon.png">]({{site.baseurl}}/onduleursolaredge/{{page.lang}})
...
[Proxmox]({{site.baseurl}}/portainer/{{page.lang}})

<img width="77" src="{{site.market}}/filestore/market/plugin/images/proxmox_icon.png">
...
- [Documentation]({{site.baseurl}}/portainer/{{page.lang}}/changelog)
- Changelog

# <a href="{{site.market}}/index.php?v=d&plugin_id=3835" target="_blank">Market</a>

[Rocket.Chat]({{site.baseurl}}/proxmox/{{page.lang}})

<img width="77" src="{{site.market}}/filestore/market/plugin/images/rocketchat_icon.png">
