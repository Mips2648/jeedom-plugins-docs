...
- Nouvelle page santé et/ou panel suivant vos préférences affichant un aperçu de touts les containers et permettant d'effectuer toutes les actions de base (similaire à la page "Containers" sur Portainer)
